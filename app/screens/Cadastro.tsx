...
export default function Cadastro({ navigation }: any) {
  ...
  const handleCadastrar = () => {
    ...
    if (senha !== confirmar) {
      Alert.alert('Senhas diferentes', 'A confirmação precisa ser igual.');
      return;
    }
    // TODO: integrar com Firebase Auth (createUserWithEmailAndPassword)
    Alert.alert('Cadastro', `Usuário ${nome} criado (simulação).`);
...
const styles = StyleSheet.create({
  ...
  btnPrimario: {
    backgroundColor: '#007aff', paddingVertical: 14, borderRadius: 12,
